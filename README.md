...
You can choose a method from Autoencoder, Variational Autoencoder or DCGAN. For each method we use same encoder and decoder models.

![encoder_decoder](https://github.com/hirogit1002/MA2/blob/master/model1.png)
